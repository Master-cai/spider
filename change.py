...
def convert_image(image_path):
    try:
        ...
        print("\nFail to open file %s" % image_path)
    ...
    print("\nFinished drawing emojified image ...")


    new_im.show()
    target_path = os.path.join(os.path.dirname(image_path), "emojified.png")
...
def main():
    if len(sys.argv) < 2:
        print("\nPlease specify the image file to convert.")
